...
stdenv.mkDerivation {
  pname = "quassel${tag}";
  version = "0.14.0-unstable-2026-05-18";

  src = fetchFromGitHub {
    owner = "quassel";
    repo = "quassel";
    rev = "99f9ac7cfb6da6ac3c2096cdf29642379b698e43"; # currently a PR for Qt6
    sha256 = "sha256-k8Ul/3uPLKvzVMZUA4Dll+NwBQtL1/HzPmCUBKcb130=";
  };
